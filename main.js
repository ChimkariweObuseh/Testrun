...
const copyButton1 = document.querySelector("button#copy1")
const copyButton2 = document.querySelector("button#copy2")
const copyButton3 = document.querySelector("button#copy3")
const copyButton4 = document.querySelector("button#copy4")
const copyButton5 = document.querySelector("button#copy5")
const copyButton6 = document.querySelector("button#copy6")
const copyButton7 = document.querySelector("button#copy7")
const copyButton8 = document.querySelector("button#copy8")
const copyButton9 = document.querySelector("button#copy9")
const copyButton10 = document.querySelector("button#copy10")
